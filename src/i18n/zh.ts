export default {
  ...
  config: {
    ...
    projectSubtitle: '产品编码矩阵。输入项目编辑码解锁后即可修改。',
    projColProductLine: '产品线',
    projColCustomerCode: '客户代号',
    projColProjectNo: '项目号',
    projColYearInfo: '年度信息',
    projColCompanyCode: '公司代号',
    projColSerialNo: '产品流水号',
    projColProductTypeCode: '产品类型代号',
    projColComposite: '综合编码',
    projColComments: '备注',
    projAddRow: '新增行',
    projRemoveRow: '删除行',
    projSelectLine: '请选择…',
    projFilter: '搜索项目编码…',
    projNoMatch: '无匹配结果。',
    projExportCsv: '导出 CSV',
    projImportCsv: '导入 CSV',
    projImportDone: '已导入 {n} 行，请检查后保存',
    projImportError: '无法解析该 CSV',
    projDupError: '存在重复的综合编码：{codes}，请修改后再保存。',
    projectsSaved: '产品编码矩阵已保存',
    projEmpty: '暂无数据。解锁后新增一行。',
    searchTeams: '搜索团队…',
  ...
  form: {
    ...
    taskSummary: '任务摘要',
    fivePartInput: '四段式结构化输入',
    vehicle: '车型',
    product: '产品',
    compositeCode: '综合编码',
    compositeCodePlaceholder: '搜索综合编码…',
    codeResults: '条编码',
    codeNoResults: '无匹配编码',
    layer: '分层',
    component: '组件',
  ...
  coach: {
    ...
    chatsNav: '对话',
    chatsComingSoon: '敬请期待',
    chatsSelect: '选择对话',
    chatsSelected: '已选 {n} 项',
    chatsSelectAll: '全选',
    chatsMoveToProject: '移至项目',
    chatsCancel: '取消',
    chatsDaysAgo: '{n} 天前',
    exploreRecents: '最近',
    exploreNoChats: '暂无对话',
